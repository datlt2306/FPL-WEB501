        ...
        <div className="container marketing">
            ...
            <div className="row">
                <div className="col-lg-4">
                    ...
                    <p>
                        Some representative placeholder content for the three columns of text below
                        the carousel. This is the first column.
                    </p>
                    <p>
            ...
            <div className="row featurette">
                <div className="col-md-7 order-md-2">
                    ...
                    <p className="lead">
                        Another featurette? Of course. More placeholder content here to give you an
                        idea of how this layout would work with some actual real-world content in
                        place.
                    </p>
                </div>
